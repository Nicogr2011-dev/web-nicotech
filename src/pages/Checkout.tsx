    ...
    <div className="flex min-h-screen flex-col bg-mist">
      ...
      <main className="mx-auto w-full max-w-lg flex-1 px-4 py-16 sm:px-6">
        ...
        <Card className="mt-8 p-6">
          <h2 className="font-display text-lg font-bold text-ink">Método de pago</h2>

          <div className="mt-4 space-y-3">
            <div className="flex items-center justify-between rounded-xl border border-black/10 px-4 py-3 opacity-50">
              <span className="text-sm font-medium text-ink">Tarjeta de crédito/débito</span>
              <span className="text-xs text-slate">Próximamente</span>
            </div>
            <div className="flex items-center justify-between rounded-xl border border-black/10 px-4 py-3 opacity-50">
              <span className="text-sm font-medium text-ink">PayPal</span>
              <span className="text-xs text-slate">Próximamente</span>
            </div>

            <div className="rounded-xl border-2 border-azure bg-azure/5 px-4 py-3">
              <div className="flex items-center justify-between">
                <span className="text-sm font-semibold text-ink">Código de acceso</span>
